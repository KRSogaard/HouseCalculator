...
namespace HouseCalculator.ViewModels
{
    public class YearViewModel : BindableBase
    {
        ...
        public string MonthlyCHI => "$" + String.Format("{0:n}", Math.Round(year.CashInHand / 12, 2));
        public string MonthlyCHIPtc =>  Math.Round((year.CashInHand / result.OutOfPocket) * 100, 2) + "%";
